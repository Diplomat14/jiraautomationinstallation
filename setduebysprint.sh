...
jacustomization-main -s "https://DOMAIN.atlassian.net" -u "user@server.com" -at "ACCESSTOKEN_GOTOYOUR_JIRA_PROFILE" -log "results/log.txt" -o SetDueBySprint -q "$QUERY" -sdbsS "YOUR SPRINT 1=2019-1-1,YOUR SPRINT 2=2019-1-14"
