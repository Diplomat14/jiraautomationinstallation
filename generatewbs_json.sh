...
jacustomization-main @jira_server.cfg -log "output/generatewbs/log.txt" -out "output/generatewbs/WBS.json" -o GenerateWBSJson -q "QUERY_TO_WBS_ROOT_ELEMENTS_DOWN_TO_EPIC" -gwbsEC "Epic Category" -gwbsPERTO "PERT_OPTIMISTIC_FIELD_NAME" -gwbsPERTR "PERT_REALISTIC_FIELD_NAME" -gwbsPERTP "PERT_PESSIMISTIC_FIELD_NAME" -gwbsNWTM "MACRO_GROUP_ISSUE_TYPE=FMG,GROUP_ISSUE_TYPE=FG,HIGH_LEVEL_FEATURE_TYPE=FHLF,FEATURE_TYPE=FBS" -gwbsC2T "components2team.yml" -rfnpk "ISSUE_KEY_FOR_OTHER_ITEMS" -sntype "ROOT_ISSUES_TYPE" -lkrule "PARENTAL_LINK_NAME" -gwbswt "MACRO_GROUP_ISSUE_TYPE,GROUP_ISSUE_TYPE,HIGH_LEVEL_FEATURE_TYPE,FEATURE_TYPE"
